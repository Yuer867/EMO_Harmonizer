...
from convert_key import find_key_hooktheory, switch_melody
...
if __name__ == '__main__':
    ...
    midi_home = os.path.join(data_home, 'midis_chord11')
    ...
    lead_sheet_events_dir = 'hooktheory_events/lead_sheet_chord11_{}/events'.format(representation)
    ...
    for file in tqdm(midi_files):
        ...
        melody_pos, chord_pos, events = corpus2lead(lead_data, emotion, relative_chord=relative_chord, relative_melody=relative_melody)
